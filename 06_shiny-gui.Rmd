...
* **Substance** allows different solutes to be inspected, if these have been recorded in the dataset.  Use the drop-down menu to select this.
...
\parbox{370pt}{{%\fontfamily{phv}\selectfont 
