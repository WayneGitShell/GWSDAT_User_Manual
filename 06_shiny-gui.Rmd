...
moved to any convenient position by clicking and dragging with the mouse. Figure \@ref(fig:MultivarGWSDATTimeSeriesPlot) displays an exampleGWSDAT Matrix Time Series plot with a subset of the original date range. 
